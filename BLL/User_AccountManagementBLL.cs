...
namespace BLL
{
    ...
    public class User_AccountManagementBLL : UserDataValidatorBLL
    {
        ...
        //TODO: Implement this method to update the customer profile
        public bool UpdateCustomerProfile(string iD, string newFullName, string newPhone)
        {
            throw new NotImplementedException();
        }
    }
    // A DTO to hold all user profile related data for the BLL to return
    public class UserProfileData
    {
        public Account Account { get; set; }
        public Customer Customer { get; set; }
        public List<CourseCategory> RegisteredCourses { get; set; }
        public List<CourseCategory> FavoriteCourses { get; set; }
        public List<Lesson> LessonHistory { get; set; }
        public List<Lesson> FavoriteLessons { get; set; }

        public UserProfileData()
        {
            RegisteredCourses = new List<CourseCategory>();
            FavoriteCourses = new List<CourseCategory>();
            LessonHistory = new List<Lesson>();
            FavoriteLessons = new List<Lesson>();
        }
    }
}  
